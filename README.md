...
Kisisel Prison maden dunyasi Java eklentisi. Minecraft **1.21.11** icin, GUI menuler,
sag-tikla acilan kazma yukseltme sistemi ve hazir kit dahil.

## Ozellikler

- `/maden` - madenin yoksa olusturur (Multiverse ile), varsa isinlatir ve ayarlar menusunu acar
- `/maden sil` - madenini siler (Multiverse "confirm" hatasi fix'i dahil)
...
### Yontem B: Bilgisayarinda (Java 17 + Maven)
